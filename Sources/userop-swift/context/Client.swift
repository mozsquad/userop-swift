...
public class Client: IClient {
    ...
    public func estimateUserOperationGas(sender: EthereumAddress, initCode: Data) async throws -> GasEstimate {
        ...
        let op = UserOperation(sender: sender, nonce: nonce, initCode: initCode, callData: callData, callGasLimit: defaultCallGasLimit, verificationGasLimit: defaultVerificationGasLimit, preVerificationGas: defaultPreVerificationGas, maxFeePerGas: 0, maxPriorityFeePerGas: 0, paymasterAndData: paymasterAndData, signature: signature)
